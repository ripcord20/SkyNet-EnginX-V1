...
const startServer = async () => {
  try {
    ...
    try {
      await require('./services/RadiusService').ensureSchema();
      logger.info('Synced: RADIUS (FreeRADIUS MySQL tables)');
    } catch (e) {
      logger.warn('Failed to sync RADIUS schema: ' + (e.message || e));
    }
