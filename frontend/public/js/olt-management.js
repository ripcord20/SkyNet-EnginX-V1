...
const OltMgmt = {
  ...
  onBrandChange() {
    ...
    const hints = {
      ...
      cdata: 'CDATA GPON: interface gpon 0/N, ONU pakai serial. Default pabrik sering admin / Xpon@Olt9417#.',
      'cdata-epon': 'CDATA EPON: interface epon 0/N, ONU pakai MAC (bukan SN GPON).',
      vsol: 'VSOL dan banyak OEM GPON memakai pola CLI yang sama dengan CDATA GPON.',
      hioso: 'HIOSO GPON: interface gpon 1/N, perintah ont confirm / show ont info, ONU pakai serial.',
      'hioso-epon': 'HIOSO EPON: interface epon 0/N, ONU pakai MAC. Uji Test Koneksi — firmware HIOSO EPON bervariasi.',
      zimmlink: 'ZIMMLINK GPON memakai pola CLI sekeluarga CDATA (Cortina).',
      hsgq: 'HSGQ EPON E04/E08: ONU diidentifikasi MAC. PON 1–4 (E04) atau 1–8 (E08).',
      'hsgq-epon': 'HSGQ EPON E04/E08: ONU diidentifikasi MAC. PON 1–4 (E04) atau 1–8 (E08).',
      'hsgq-gpon': 'HSGQ GPON: interface gpon 0/N, ONU pakai serial (bukan MAC). Bukan E04/E08 EPON.',
